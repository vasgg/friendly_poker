...
texts = {
    ...
    'admin_menu_player_buy_ins_header': 'Current players and BUY-IN:',
    'admin_menu_player_buy_in_line': '{}: <b>{}</b>',
    'admin_menu_player_buy_in_empty': 'No players added yet.',
    ...
    'game_no_longer_active': 'Game {:02} is no longer active. Open /admin again.',
    'select_mode_prompt': 'Select ratio for the next game.',
    'ratio_confirm': 'Set next game ratio to x{}?',
    'ratio_set': 'Next game ratio: x{}.',
    'ratio_set_group': 'Next game ratio set to <b>x{ratio}</b> by <b>{admin_name}</b>.',
    'next_game_settings_stale': 'Next game settings were changed by another admin. Open the menu again.',
    'yearly_stats_confirm': 'Send yearly stats after next game?',
    'yearly_stats_set': 'Yearly stats will be sent after the next game.',
    'yearly_stats_unset': 'Yearly stats will not be sent after the next game.',
    ...
    'photo_reminder_group': 'Game {game_id}. Don\'t forget to take a photo! {admin_mention}\n'
                            'Any player can save the photo, but only by replying to this message with an image.',
    'photo_saved_player': 'Game {game_id}. Photo saved: {filepath}',
    'photo_saved_admin': 'Game {game_id}. Photo saved by {uploader_label}: {filepath}',
    'photo_save_failed_admin': 'Game {game_id}. Photo save failed for {uploader_label} ({uploader_id}). '
                               'Error: {error_type}: {error_message}',
    'photo_save_failed_player': 'Game {game_id}. Failed to save photo. The admin has been notified.',
    'photo_upload_forbidden': 'Game {game_id}. Only a player from this game can upload a photo.',
    'start_greeting': 'Hi, {}.',
...
buttons = {
    ...
    'debt_paid': 'Debt paid',
    'debt_confirm_payment': 'Confirm payment',
    'skip_photo': 'Ignore',
